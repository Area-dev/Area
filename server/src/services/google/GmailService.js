...
const config = require('./configs/gmail');
const gmailActions = require('./actions/gmail')
const gmailReactions = require('./reactions/gmail')

class GmailService extends ServiceInterface {
  constructor() {
    super();
    this.name = config.name;
    this.actions = gmailActions;
    this.reactions = gmailReactions;
  }
